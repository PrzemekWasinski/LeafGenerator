...
This is a small project I made one evening in Racket, it randomly generates a leaf while following some simple rules such as a minimum and maximum length, width, angle etc.
...
To try this program copy the code from `leaf_generator.rkt` into a Racket IDE and run it
